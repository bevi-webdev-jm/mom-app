...
@section('subtitle', __('adminlte::types.update_type'))
@section('content_header_title', __('adminlte::types.types'))
@section('content_header_subtitle', __('adminlte::types.update_type'))
    ...
    {{ html()->form('POST', route('type.update', encrypt($type->id)))->open() }}
        ...
        <div class="card">
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">{{__('adminlte::types.update_type')}}</strong>
                    </div>
            ...
            <div class="card-footer text-right">
                {{ html()->submit('<i class="fa fa-save"></i> '.__('adminlte::types.update_type'))->class(['btn', 'btn-primary', 'btn-sm']) }}
            </div>
        </div>
