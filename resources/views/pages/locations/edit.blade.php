...
@section('subtitle', __('adminlte::locations.update_location'))
@section('content_header_title', __('adminlte::locations.locations'))
@section('content_header_subtitle', __('adminlte::locations.update_location'))

{{-- Content body: main page content --}}
@section('content_body')
    {{ html()->form('POST', route('location.update', encrypt($location->id)))->open() }}

        <div class="card">
            <div class="card-header py-2">
                <div class="row">
                    <div class="col-lg-6 align-middle">
                        <strong class="text-lg">{{__('adminlte::locations.update_location')}}</strong>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {{ 
                                html()->text('location_name', $location->location_name)
                    ...
                    <div class="col-lg-4">
                        <div class="form-group">
                            ...
                            {{ 
                                html()->text('address', $location->address)
